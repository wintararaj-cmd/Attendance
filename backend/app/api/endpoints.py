    ...
    try:
        ...
        return {
            ...
            "rules": {
                ...
                "pf_use_slabs": getattr(rules, 'pf_use_slabs', False),
                "pf_slabs": getattr(rules, 'pf_slabs', None),
...
def reset_employee_payroll_rules(emp_id: str, db: Session = Depends(get_db), current_user: AdminUser = Depends(get_current_user)):
    ...
    try:
        ...
        new_rules = EmployeePayrollRules(
            ...
            pf_use_slabs=DEFAULT_PAYROLL_RULES['pf_use_slabs'],
            pf_slabs=DEFAULT_PAYROLL_RULES['pf_slabs'],
